 ...
 *             Porpose Input Output Pins for ATMEGA32             	                                 
 *
...
#define INPUT    0    /*!< @def INPUT  this Macro is used to be an Input parmeter to Select The state of pin */
#define OUTPUT   1    /*!< @def INPUT  this Macro is used to be an Input parmeter to Select The state of pin */
